        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    evAdresi = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    sehir = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    telefonNo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    anneAd = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    babaAd = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OkulAd = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Okul_AspNetUsers_ManagerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Dersler_OkulId",
                table: "Dersler",
                column: "OkulId");

            migrationBuilder.CreateIndex(
                name: "IX_Okul_ManagerId",
                table: "Okul",
                column: "ManagerId");
